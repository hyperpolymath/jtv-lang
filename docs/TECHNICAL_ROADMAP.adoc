...
This document provides the comprehensive technical roadmap for JtV,
covering language specification, compiler architecture, tooling,
standard library, and ecosystem development.
...
* [x] 7 Number Systems: Int, Float, Rational, Complex, Hex, Binary,
Symbolic
...
[arabic]
. Fix parser issues (comparisons in conditions)
