...
**Caveat:** v1 alpha is partially implemented (parser and interpreter stubs exist); the full Rust `jtzig` crate referenced in the README is not yet present. v2 (reversible computing) is specification-only.
