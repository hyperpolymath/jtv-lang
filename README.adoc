...
image:https://img.shields.io/badge/Docs-CC--BY--SA--4.0-blue.svg[Docs: CC-BY-SA-4.0,link="LICENSING.md"]
...
Dual-licensed by artifact type: **source code** under link:LICENSE[MPL-2.0]
(Mozilla Public License 2.0); **documentation** under
https://creativecommons.org/licenses/by-sa/4.0/[CC-BY-SA-4.0].
See link:LICENSING.md[LICENSING.md] for details.
