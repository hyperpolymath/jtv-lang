...
// Replace jtv, jtv-lang, {{DEPS}} with actuals
...
| `$PREFIX/share/jtv-lang/`
| Data files, assets

| `$PREFIX/share/doc/jtv-lang/`
| Documentation
...
Default config location: `$XDG_CONFIG_HOME/jtv-lang/config.toml`

Fallback: `$HOME/.config/jtv-lang/config.toml`
...
Or via OPSM: `opsm update jtv-lang`
...
[source,bash]
----
just install --prefix=/opt/jtv-lang-instance1 --config=/etc/jtv-lang/instance1.toml
just install --prefix=/opt/jtv-lang-instance2 --config=/etc/jtv-lang/instance2.toml
----
