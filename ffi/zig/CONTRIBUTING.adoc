...
git clone https://github.com/hyperpolymath/julia-zig-ffi.git cd
julia-zig-ffi
...
toolbox create julia-zig-ffi-dev toolbox enter julia-zig-ffi-dev #
...
julia-zig-ffi/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
...
- [`good first issue`](https://github.com/hyperpolymath/julia-zig-ffi/labels/good%20first%20issue) — Simple Perimeter 3 tasks
- [`help wanted`](https://github.com/hyperpolymath/julia-zig-ffi/labels/help%20wanted) — Community help needed
- [`documentation`](https://github.com/hyperpolymath/julia-zig-ffi/labels/documentation) — Docs improvements
- [`perimeter-3`](https://github.com/hyperpolymath/julia-zig-ffi/labels/perimeter-3) — Community sandbox scope
