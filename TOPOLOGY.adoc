...
Named after mathematician Julia Robinson and playful "`adder`" (snake +
addition), JtV makes code injection grammatically impossible by
separating computation into two distinct channels: Control Language
(Turing-complete) and Data Language (total, addition-only).
